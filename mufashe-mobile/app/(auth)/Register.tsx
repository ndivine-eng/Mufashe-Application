...
export default function RegisterScreen() {
  ...
  const onSignup = async () => {
    ...
    try {
      ...
      //  robust redirect (even if role not returned, defaults to user)
      const role = String(result?.user?.role || "user").toLowerCase();
      if (role === "admin") router.replace("/(user)/admin-dashboard");
      else if (role === "lawyer") router.replace("/(lawyer)/dashboard");
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        ...
        >
          <ScrollView
            ...
            contentContainerStyle={[styles.container, { paddingBottom: 22 + kbHeight }]}
          >
            ...
            <View style={styles.form}>
              ...
              <View style={styles.inputWrap}>
                <View style={styles.inputIconBox}>
                  <Ionicons name="id-card-outline" size={18} color={theme.textSub} />
                </View>
                <TextInput
                  style={styles.input}
              ...
              <View style={styles.inputWrap}>
                <View style={styles.inputIconBox}>
                  <Ionicons name="checkmark-circle-outline" size={18} color={theme.textSub} />
                </View>
                <TextInput
                  style={styles.input}
                  ...
                  autoCapitalize="none"
                />
                <TouchableOpacity onPress={() => setShowConfirm((v) => !v)} style={styles.eyeBtn} activeOpacity={0.8}>
...
function makeStyles(theme: any, s: number) {
  ...
  return {
    ...
    errorRow: { flexDirection: "row", alignItems: "center", gap: 8, marginTop: 10, padding: 10, borderRadius: 12, borderWidth: 1, borderColor: danger, backgroundColor: `${danger}10` },
